...
export class GoalService {
    ...
    async update(id, data, tx) {
        ...
        if (data.matchId !== undefined)
            updateData.match_id = BigInt(data.matchId);
    ...
    async list(page, limit, filter, tx) {
        ...
        Object.assign(where, buildBooleanFilter("is_own_goal", filter.isOwnGoal));
        const result = await paginate(goalRepository, { page, limit }, {
            where,
