 ...
 */
router.post("/", strictLimiter, roleGuard(["ADMIN"]), validateSchema(createLeagueSchema), leagueController.create);
/**
 * @openapi
 * /leagues/{id}:
 *   put:
 ...
 */
router.put("/:id", roleGuard(["ADMIN"]), validateSchema(updateLeagueSchema), leagueController.update);
/**
 * @openapi
 * /leagues/{id}:
 *   delete:
