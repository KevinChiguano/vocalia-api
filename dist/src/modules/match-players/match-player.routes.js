 ...
 */
router.post("/bulk", roleGuard(["ADMIN", "VOCAL"]), validateSchema(bulkCreateMatchPlayerSchema), matchPlayerController.bulkCreate);
/**
 * @openapi
 ...
 */
router.delete("/match/:matchId", roleGuard(["ADMIN", "VOCAL"]), matchPlayerController.deleteByMatch);
/**
 * @openapi
 * /match-players/match/{matchId}:
 *   get:
 ...
 */
router.get("/match/:matchId", roleGuard(["ADMIN", "VOCAL"]), matchPlayerController.listByMatch);
