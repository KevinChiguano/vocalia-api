...
import { createTournamentTeamSchema, updateTournamentTeamSchema, } from "./tournament-team.schema";
const router = Router();
 ...
 */
router.post("/", roleGuard(["ADMIN"]), validateSchema(createTournamentTeamSchema), tournamentTeamController.create);
/**
 * @openapi
 * /tournament-teams/{id}:
 *   put:
 ...
 */
router.put("/:id", roleGuard(["ADMIN"]), validateSchema(updateTournamentTeamSchema), tournamentTeamController.update);
/**
 * @openapi
 * /tournament-teams/{id}:
 *   delete:
 ...
 */
router.get("/tournament/:tournamentId", tournamentTeamController.listByTournament);
