 ...
 */
router.post("/", strictLimiter, roleGuard(["ADMIN"]), validateSchema(createUserSchema), userController.create);
/**
 * @openapi
 * /users/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/UserResponse'
 */
router.put("/:id", roleGuard(["ADMIN"]), validateSchema(updateUserSchema), userController.update);
/**
 * @openapi
 * /users/{id}:
 *   delete:
