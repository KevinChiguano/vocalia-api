 ...
 */
export const invalidateTournamentStats = async (tournamentId) => {
    try {
        ...
        console.warn(`[CACHE] No se pudo invalidar stats del torneo ${tournamentId}`, error);
    }
};
/**
 ...
 */
export const invalidateStatsByMatch = async (matchId) => {
    try {
        ...
        console.warn(`[CACHE] No se pudo invalidar stats por match ${matchId}`, error);
    }
};
