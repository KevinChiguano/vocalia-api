...
describe("MatchPlayerService", () => {
    ...
    describe("bulkCreate()", () => {
        it("borra planilla previa y crea jugadores", async () => {
            matchPlayerRepository.deleteByMatch.mockResolvedValue({});
            matchPlayerRepository.createMany.mockResolvedValue({});
    ...
    describe("listByMatch()", () => {
        it("retorna jugadores mapeados", async () => {
            matchPlayerRepository.findByMatch.mockResolvedValue([
                {
                    match_player_id: 1,
                    is_starting: true,
                    player: {
