...
export class UserService {
  async create(data: CreateUserInput, tx?: PrismaTx) {
  ...
  async update(id: number, data: UpdateUserInput, tx?: PrismaTx) {
    const updateData: any = {};

    if (data.name) updateData.user_name = data.name;
    if (data.email) updateData.user_email = data.email;
    if (data.rolId) updateData.rol_id = data.rolId;
